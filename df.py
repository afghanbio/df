...
logo = ("""
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m Riddu NOOB     \033[1;32m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m Riddu999      \033[1;32m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35mHridoy0777        \033[1;32m ║
...
def riddu():
    ...
    os.system("clear")
    print(logo)
    print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Example : {xr}9377,9370,9378{x}')
    print(" \033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××")
    rk1 = '0191'
    rk2 = '0172'
    rk3 = '0165'
